...
public class VSimpleTurn extends CommandBase {
  ...
  /**
   * constructor for VSimpleTurn
   * @param Drivetrain, Joystick, double
   */
  ...
  /**
   * intializes sum, steer, fin_time, and status
   */
  @Override
  ...
  /**
   * initializes a PID loop and moves the robot until it reaches the threshold
   */
  @Override
  public void execute() 
  {
  ...
  /**
   * checks if robot t(x) has reached the threshold and the fin_time is >= 10 (for some reason)
   * @return boolean
   */
  @Override
