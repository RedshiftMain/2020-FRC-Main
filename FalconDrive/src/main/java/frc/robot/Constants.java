...
public final class Constants 
{
    ...
    public static class SpeedConstants
    {
        ...
        //needs to be experimentally found, will be used for the coolbeans auto in the robot container
    ...
    public static class ShooterConstants
    {
        ...
        /**
         * @apiNote Gains may have to be adjusted based on the responsiveness of control loop.
         * kF: 1023 represents output value to Talon at 100%, 20660 represents Velocity units at 100% output
         * 
         * 	                                    	   	        kP     kI    kD      kF         Iz  PeakOut 
         */
        //public final static Gains kGains_Velocit  = new Gains( 0.2, 0.00001, 8, 1023.0/21264,  100,  1.00);
        public final static Gains kGains_Velocit  = new Gains( 0.2, 0.0, 0, 1023.0/21264,  100,  1.00);
    }
